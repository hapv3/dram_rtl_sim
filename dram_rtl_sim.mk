...
$(DRAMSYS_ROOT)/.patched:
	...
	cd $(DRAMSYS_ROOT) && git reset --hard 8e021ea && git apply $(DRAM_RTL_SIM_ROOT)/dramsys_lib/dramsys_v2.patch
	@touch $@

# Build DRAMSys
$(DRAMSYS_BUILD_DIR)/lib/libsystemc.so: $(DRAMSYS_ROOT)/.patched
	mkdir -p $(DRAMSYS_BUILD_DIR)
	cd $(DRAMSYS_BUILD_DIR) && $(CMAKE) -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCMAKE_CXX_FLAGS=-fPIC -DCMAKE_C_FLAGS=-fPIC -D DRAMSYS_WITH_DRAMPOWER=ON -DENABLE_PTHREADS=ON $(DRAMSYS_ROOT)
